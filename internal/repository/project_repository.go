...
type ProjectRepository interface {
	...
	Reorder(ctx context.Context, id, categoryID string, orderedIDs []string, at time.Time) error
	...
	ReorderCategory(ctx context.Context, id string, parentID *string, orderedIDs []string, at time.Time) error
